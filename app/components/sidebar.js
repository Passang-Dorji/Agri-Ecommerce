  ...
  return (
    <div>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div class="h-full px-2 mt-16 py-4 overflow-y-auto bg-gray-50 dark:bg-[#485696]">
          <ul class="space-y-6 font-medium">
            ...
            <li>
              <Link
                href="http://localhost:3000/pages/inventory"
            ...
            <li>
              <Link
                href="http://localhost:3000/pages/products"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <Link
                href="http://localhost:3000/pages/transaction"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <Link
                href="http://localhost:3000/pages/transactionHis"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Stock Update</span>
              </Link>
            </li>
          </ul>
        </div>
